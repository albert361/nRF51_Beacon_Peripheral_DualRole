...
/** @file
 *
 * @defgroup ble_sdk_app_doorlock_main main.c
 * @{
 * @ingroup ble_sdk_app_doorlock
...
#define DEVICE_NAME                      "LeoX1"                                    /**< Name of device. Will be included in the advertising data. */
...
static uint8_t m_beacon_info[app_doorlock_INFO_LENGTH] =                            /**< Information advertised by the Beacon. */
{
    APP_DEVICE_TYPE,                                                                // Manufacturer specific information. Specifies the device type in this 
                                                                                    // implementation. 
    APP_ADV_DATA_LENGTH,                                                            // Manufacturer specific information. Specifies the length of the 
                                                                                    // manufacturer specific data in this implementation.
    app_doorlock_UUID,                                                              // 128 bit UUID value. 
...
static void advertising_init(void)
{
    ...
    manuf_specific_data.data.size   = app_doorlock_INFO_LENGTH;
...
{
    // Configure leds. (TODO change to control door lock)
    LEDS_CONFIGURE((BSP_LED_3_MASK));

    // Turn leds off. (TODO change to control door lock)
